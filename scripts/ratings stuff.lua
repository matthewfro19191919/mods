...
if songName == 'Cheating' or songName == 'Unfairness' or songName == 'Exploitation' or songName == 'Polygonized' or songName == 'Interdimensional' or songName == 'Exploitation-old' then
    for i = 0, getProperty('notes.length')-1 do
      if getPropertyFromGroup('notes', i, 'texture') == 'notes/NOTE_assets_3D' then
        combType = '3D/combo'
        numPrefix = '3D/num'
        numSuffix = ''
    ...
    if boyfriendName == '3d-bf' or songName == 'Algebra' or noteType == '3d_notes' then
        combType = '3D/combo'
        numPrefix = '3D/num'
        numSuffix = ''
        ratingGrab = {'3D/sick', '3D/good', '3D/bad', '3D/shit'}
