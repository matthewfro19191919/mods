...
local song = 'badEnding'; --If you want to have a song play while people are in this menu. Remove this line entirely if you don't want one.
...
local characterList = { -- The list of characters
	...
	{
		name = "expunged-3d-playable",
		displayName = "True Expunged",
	},
	{
		name = "unfair-3d-playable",
		displayName = "Unfair Expunged",
	},
	{
		name = "bambi-3d-playable",
		displayName = "Cheating Expunged",
	},
	{
		name = "tristan-golden",
		displayName = "Golden Tristan",
	},
	{
		name = "tristan",
		displayName = "Tristan",
	...
	{
		name = "angy-bambi-playable",
		displayName = "Angry Bambi",
	},
	{
		name = "bambi-new-playable",
		displayName = "Bambi",
	},
	{
		name = "dave-angey-playable",
		displayName = "Dave 3d",
	},
	{
		name = "dave-insanity-playable",
		displayName = "Dave-Insanity",
	},
	{
		name = "dave-playable",
		displayName = "Dave",
	...
	{
		name = "3d-bf-alg",
		displayName = "3D Boyfriend Gapple",
	},
	{
		name = "3d-bf",
...
function onCreate()
	...
	if(songPath == 'polygonized') and enabled == true then
		enabled = false
	end
